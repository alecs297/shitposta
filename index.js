...
app.use('/infinity', async function (req, res, next) {
    ...
    res.send(`<!DOCTYPE html><html lang="en"><head><title>"hit F5 | ${id}"</title></head><meta charset="utf-8"><iframe src="/${id}" style="position:fixed; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;">Your browser doesn't support iframes :'(</iframe></html>`)
})
